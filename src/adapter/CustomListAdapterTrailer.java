...
public class CustomListAdapterTrailer extends BaseAdapter implements Filterable {
	...
	public CustomListAdapterTrailer(Activity activity, List<Movie> movieItems,
			Context ctx) {
